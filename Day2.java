public class Main {
    ...
    public static void main (String[] args) throws Exception {
      test();
	    ...
	    // Second part.
	    System.out.println(countValidPasswords2(passwords));
    }
    ...
    // FIXME: test passes but the solution is not right.
    public static int countValidPasswords2 (String[] passwords) {
        int validCount = 0;
        ...
        for (int i = 0; i < passwords.length; i++) {
            ...
            int position1 = Integer.parseInt(positions[0]) - 1;
            int position2 = Integer.parseInt(positions[1]) - 1;
            
            char letter = args[1].charAt(0);
            
            if (args[2].length() - 1 >= position2) {
                if ((args[2].charAt(position1) == letter) ^ (args[2].charAt(position2) == letter)) {
                    validCount++;
                }
            }
        }
    ...
    public static void test () {
        ...
        // countValidPasswords() test.
        int validPasswords = countValidPasswords(passwords);
        System.out.println(validPasswords + " == 2 ? => " + (validPasswords == 2));
	    
	      // countValidPasswords2() test.
        validPasswords = countValidPasswords2(passwords);
        System.out.println(validPasswords + " == 1 ? => " + (validPasswords == 1));
